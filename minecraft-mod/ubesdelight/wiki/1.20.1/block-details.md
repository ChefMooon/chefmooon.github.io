...
- **result**: An array of items produced by the recipe. Each recipe must specify 1-4 result items. For each item, a "count" value can be specified (defaults to 1 if not set).
